'''
Adapted from https://github.com/starVLA/starVLA/tree/starVLA/starVLA/model/modules/vlm/tools/add_qwen_special_tokens
'''
...
def add_new_tokens(
    ...
    if target_size > old_embed_size:
        model.resize_token_embeddings(target_size, mean_resizing=True)  # resizing to target size
...
def main():
    parser = argparse.ArgumentParser(
        description="Add special tokens to QwenX-VL model and save to local directory."
    )
